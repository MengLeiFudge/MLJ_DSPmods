...
public static class ProtoID {
    ...
    internal const int IFE交互塔 = 8001;
    internal const int IFE矿物复制塔 = 8002;
    internal const int IFE行星矿物复制塔 = 8003;
    internal const int IFE点数聚集塔 = 8004;
    internal const int IFE量子复制塔 = 8005;
    internal const int IFE点金塔 = 8006;
    internal const int IFE分解塔 = 8007;
    internal const int IFE转化塔 = 8008;
    internal const int IFE分馏原胚普通 = 8011;
    internal const int IFE分馏原胚精良 = 8012;
    internal const int IFE分馏原胚稀有 = 8013;
    internal const int IFE分馏原胚史诗 = 8014;
    internal const int IFE分馏原胚传说 = 8015;
    internal const int IFE分馏原胚定向 = 8016;
    internal const int IFE复制精华 = 8021;
    internal const int IFE点金精华 = 8022;
    internal const int IFE分解精华 = 8023;
    internal const int IFE转化精华 = 8024;
    internal const int IFE电磁奖券 = 8031;
    internal const int IFE能量奖券 = 8032;
    internal const int IFE结构奖券 = 8033;
    internal const int IFE信息奖券 = 8034;
    internal const int IFE引力奖券 = 8035;
    internal const int IFE宇宙奖券 = 8036;
    internal const int IFE黑雾奖券 = 8037;
    internal const int IFE分馏配方核心 = 8038;
    internal const int IFE建筑增幅芯片 = 8039;
    ...
    internal const int RFE交互塔 = 801;
    internal const int RFE矿物复制塔 = 802;
    internal const int RFE行星矿物复制塔 = 803;
    internal const int RFE点数聚集塔 = 804;
    internal const int RFE量子复制塔 = 805;
    internal const int RFE点金塔 = 806;
    internal const int RFE分解塔 = 807;
    internal const int RFE转化塔 = 808;
    internal const int RFE分馏原胚普通 = 811;
    internal const int RFE分馏原胚精良 = 812;
    internal const int RFE分馏原胚稀有 = 813;
    internal const int RFE分馏原胚史诗 = 814;
    internal const int RFE分馏原胚传说 = 815;
    internal const int RFE分馏原胚定向 = 816;
    internal const int RFE复制精华 = 821;
    internal const int RFE点金精华 = 822;
    internal const int RFE分解精华 = 823;
    internal const int RFE转化精华 = 824;
    internal const int RFE电磁奖券 = 831;
    internal const int RFE能量奖券 = 832;
    internal const int RFE结构奖券 = 833;
    internal const int RFE信息奖券 = 834;
    internal const int RFE引力奖券 = 835;
    internal const int RFE宇宙奖券 = 836;
