...
public static class ProtoID {
    ...
    internal const int IFE点数聚集塔 = 2354;
    internal const int IFE量子复制塔 = 2355;
    internal const int IFE点金塔 = 2356;
    internal const int IFE分解塔 = 2357;
    internal const int IFE转化塔 = 2358;
