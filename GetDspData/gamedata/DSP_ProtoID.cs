static class ProtoID
{
    ...
    internal const int I通用分馏塔 = 2314;
    ...
    internal const int I精准分馏塔 = 2320;
    internal const int I建筑极速分馏塔 = 2321;
    internal const int I点数聚集分馏塔 = 2322;
    internal const int I增产分馏塔 = 2323;
    ...
    internal const int M精准分馏塔 = 530;
    internal const int M建筑极速分馏塔 = 531;
    internal const int M点数聚集分馏塔 = 532;
    internal const int M增产分馏塔 = 533;
    ...
    internal const int R精准分馏塔 = 1001;
    internal const int R建筑极速分馏塔 = 1002;
    internal const int R点数聚集分馏塔 = 1004;
    internal const int R增产分馏塔 = 1005;
    internal const int R精准分馏塔分馏 = 1010;
    internal const int R建筑极速分馏塔分馏 = 1011;
    internal const int R通用分馏塔分馏 = 1012;
    internal const int R点数聚集分馏塔分馏 = 1013;
    internal const int R增产分馏塔分馏 = 1014;
    internal const int R物流配送器分馏 = 1015;
    internal const int R物流运输站分馏 = 1016;
    internal const int R星际物流运输站分馏 = 1017;
    internal const int R轨道采集器分馏 = 1018;
    internal const int R铁矿分馏 = 1019;
    internal const int R铜矿分馏 = 1020;
    internal const int R硅石分馏 = 1021;
    internal const int R钛石分馏 = 1022;
    internal const int R石矿分馏 = 1023;
    internal const int R煤矿分馏 = 1024;
    internal const int R可燃冰分馏 = 1025;
    internal const int R金伯利矿石分馏 = 1026;
    internal const int R分形硅石分馏 = 1027;
    internal const int R光栅石分馏 = 1028;
    internal const int R刺笋结晶分馏 = 1029;
    internal const int R单极磁石分馏 = 1030;
    internal const int R有机晶体分馏 = 1031;
    internal const int R铁块分馏 = 1032;
    internal const int R钢材分馏 = 1033;
    internal const int R框架材料分馏 = 1034;
    internal const int R戴森球组件分馏 = 1035;
    internal const int R高纯硅块分馏 = 1036;
    internal const int R石材分馏 = 1037;
    internal const int R玻璃分馏 = 1038;
    internal const int R钛化玻璃分馏 = 1039;
    internal const int R棱镜分馏 = 1040;
    internal const int R电浆激发器分馏 = 1041;
    internal const int R光子合并器分馏 = 1042;
    internal const int R高能石墨分馏 = 1043;
    internal const int R石墨烯分馏 = 1044;
    internal const int R碳纳米管分馏 = 1045;
    internal const int R粒子容器分馏 = 1046;
    internal const int R奇异物质分馏 = 1047;
    internal const int R引力透镜分馏 = 1048;
    internal const int R精炼油分馏 = 1049;
    internal const int R塑料分馏 = 1050;
    internal const int R钛晶石分馏 = 1051;
    internal const int R水分馏 = 1052;
    internal const int R硫酸分馏 = 1053;
    internal const int R磁铁分馏 = 1054;
    internal const int R磁线圈分馏 = 1055;
    internal const int R电动机分馏 = 1056;
    internal const int R电磁涡轮分馏 = 1057;
    internal const int R超级磁场环分馏 = 1058;
    internal const int R电路板分馏 = 1059;
    internal const int R处理器分馏 = 1060;
    internal const int R量子芯片分馏 = 1061;
    internal const int R地面战斗机E型分馏 = 1062;
    internal const int R地面战斗机A型分馏 = 1063;
    internal const int R地面战斗机F型分馏 = 1064;
    internal const int R太空战斗机A型分馏 = 1065;
    internal const int R太空战斗机F型分馏 = 1066;
    internal const int R临界光子分馏 = 1067;
    internal const int R反物质分馏 = 1068;
    internal const int R能量碎片分馏 = 1069;
    internal const int R存储单元分馏 = 1070;
    internal const int R物质重组器分馏 = 1071;
    internal const int R硅基神经元分馏 = 1072;
    internal const int R负熵奇点分馏 = 1073;
    internal const int R虚粒子分馏 = 1074;
    internal const int R电磁矩阵分馏 = 1075;
    internal const int R能量矩阵分馏 = 1076;
    internal const int R结构矩阵分馏 = 1077;
    internal const int R信息矩阵分馏 = 1078;
    internal const int R引力矩阵分馏 = 1079;
    internal const int R增产剂MkI分馏 = 1080;
    internal const int R增产剂MkII分馏 = 1081;
    internal const int R增产剂MkIII分馏 = 1082;
    internal const int R燃烧单元分馏 = 1083;
    internal const int R爆破单元分馏 = 1084;
    internal const int R晶石爆破单元分馏 = 1085;
    internal const int R动力引擎分馏 = 1086;
    internal const int R推进器2分馏 = 1087;
    internal const int R加力推进器分馏 = 1088;
    internal const int R配送运输机分馏 = 1089;
    internal const int R物流运输机分馏 = 1090;
    internal const int R星际物流运输船分馏 = 1091;
    internal const int R氢燃料棒分馏 = 1092;
    internal const int R氘核燃料棒分馏 = 1093;
    internal const int R反物质燃料棒分馏 = 1094;
    internal const int R金色燃料棒分馏 = 1095;
    internal const int R机枪弹箱分馏 = 1096;
    internal const int R钛化弹箱分馏 = 1097;
    internal const int R超合金弹箱分馏 = 1098;
    internal const int R炮弹组分馏 = 1099;
    internal const int R高爆炮弹组分馏 = 1100;
    internal const int R晶石炮弹组分馏 = 1101;
    internal const int R导弹组分馏 = 1102;
    internal const int R超音速导弹组分馏 = 1103;
    internal const int R引力导弹组分馏 = 1104;
    internal const int R等离子胶囊分馏 = 1105;
    internal const int R反物质胶囊分馏 = 1106;
    internal const int R电磁干扰胶囊分馏 = 1107;
    internal const int R电磁压制胶囊分馏 = 1108;
    internal const int R电力感应塔分馏 = 1109;
    internal const int R无线输电塔分馏 = 1110;
    internal const int R卫星配电站分馏 = 1111;
    internal const int R风力涡轮机分馏 = 1112;
    internal const int R太阳能板分馏 = 1113;
    internal const int R蓄电器分馏 = 1114;
    internal const int R蓄电器满分馏 = 1115;
    internal const int R能量枢纽分馏 = 1116;
    internal const int R火力发电厂分馏 = 1117;
    internal const int R地热发电站分馏 = 1118;
    internal const int R微型聚变发电站分馏 = 1119;
    internal const int R人造恒星分馏 = 1120;
    internal const int R低速传送带分馏 = 1121;
    internal const int R高速传送带分馏 = 1122;
    internal const int R极速传送带分馏 = 1123;
    internal const int R流速器分馏 = 1124;
    internal const int R四向分流器分馏 = 1125;
    internal const int R喷涂机分馏 = 1126;
    internal const int R自动集装机分馏 = 1127;
    internal const int R小型储物仓分馏 = 1128;
    internal const int R储液罐分馏 = 1129;
    internal const int R大型储物仓分馏 = 1130;
    internal const int R低速分拣器分馏 = 1131;
    internal const int R高速分拣器分馏 = 1132;
    internal const int R极速分拣器分馏 = 1133;
    internal const int R集装分拣器分馏 = 1134;
    internal const int R采矿机分馏 = 1135;
    internal const int R大型采矿机分馏 = 1136;
    internal const int R抽水站分馏 = 1137;
    internal const int R原油萃取站分馏 = 1138;
    internal const int R原油精炼厂分馏 = 1139;
    internal const int R化工厂分馏 = 1140;
    internal const int R化工厂MkII分馏 = 1141;
    internal const int R电弧熔炉分馏 = 1142;
    internal const int R位面熔炉分馏 = 1143;
    internal const int R熔炉MkIII分馏 = 1144;
    internal const int R制造台MkI分馏 = 1145;
    internal const int R制造台MkII分馏 = 1146;
    internal const int R制造台MkIII分馏 = 1147;
    internal const int R制造台MkIV分馏 = 1148;
    internal const int R矩阵研究站分馏 = 1149;
    internal const int R矩阵研究站MkII分馏 = 1150;
    internal const int R电磁轨道弹射器分馏 = 1151;
    internal const int R射线接收站分馏 = 1152;
    internal const int R垂直发射井分馏 = 1153;
    internal const int R高斯机枪塔分馏 = 1154;
    internal const int R导弹防御塔分馏 = 1155;
    internal const int R聚爆加农炮分馏 = 1156;
    internal const int R高频激光塔分馏 = 1157;
    internal const int R磁化电浆炮分馏 = 1158;
    internal const int R地面电浆炮分馏 = 1159;
    internal const int R战场分析基站分馏 = 1160;
    internal const int R信标分馏 = 1161;
    internal const int R干扰塔分馏 = 1162;
    internal const int R护盾发生器分馏 = 1163;
    ...
    internal const int T增产点数聚集 = 1159;
    internal const int T增产分馏 = 1908;
    internal const int T分馏塔产物集装物流 = 3804;
}