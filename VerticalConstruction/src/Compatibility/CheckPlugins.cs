...
namespace VerticalConstruction.Compatibility {
    ...
    public class CheckPlugins : BaseUnityPlugin {
        public const string GUID = VerticalConstruction.GUID + ".CheckPlugins";
        public const string NAME = VerticalConstruction.NAME + ".CheckPlugins";
        public const string VERSION = VerticalConstruction.VERSION;
