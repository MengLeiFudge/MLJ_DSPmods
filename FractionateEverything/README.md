...
* 资源塔：复制可持续消耗的原矿资源，并保留硅石、石矿、煤矿、氢等配方既定的自然伴生副产物；临界光子和反物质不进入复制配方，对应协议完整度达到 100 后才可运行。
* 转化塔：在已确认的建筑、设备、燃料、防御、弹药、消耗品和黑雾物品链内转换；可以投入大量低层建筑取得下一层建筑，对应协议完整度达到 100 后才可运行。
