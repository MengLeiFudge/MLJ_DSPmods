- v2.3.0
    ...
    - 新增动态市场与残片经济，市场总览、市场板、交易所、残片兑换共同承担材料补给、残片回收和阶段资源兑换。
    - 重做任务与成就系统，主线任务改为路线图，成就改为自动获得并提供长期加成；移除循环任务，避免固定目标在后期被高速重复领取。
    ...
    - 优化分馏塔与物流交互站相关操作，补齐建筑培养、单路锁定、流动输出尾料释放、上传路径和增产点数处理等逻辑，有限上传目标数量会随物品价值调整。
