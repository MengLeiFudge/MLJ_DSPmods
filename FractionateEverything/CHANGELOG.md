- v3.0.0
    - 重构2.3主玩法，移除点金塔、分解塔、量子复制塔，收束为分馏、转化、数据中心与配方成长主线。
    - 重做抽取成长系统，拆分为开线抽取、原胚抽取、成长规划、流派聚焦与抽取总览，抽取消耗改为当前阶段矩阵，奖励直接进入分馏数据中心。
    - 重做配方成长体系，分馏配方改为解锁、升级、残片补偿与成长角色分工，配方效果围绕等级、原料保留、产物翻倍和图鉴加成重新结算。
    - 新增原版配方强化入口，原版配方页可查看和操作可强化配方，并按阶段开放对应增强。
    - 新增动态市场与残片经济，市场总览、市场板、交易所、残片兑换共同承担材料补给、残片回收和阶段资源兑换；新增记忆源点作为低频珍贵货币，和残片分离。
    - 重做任务与成就系统，主线任务改为路线图，成就改为自动获得并提供长期加成；阶段主线完成和高阶成就会给予记忆源点，移除循环任务，避免固定目标在后期被高速重复领取。
    - 增加速通模式与黑雾成长分支，部分抽取、市场、任务和重要物品展示会随模式或黑雾阶段调整。
    - 重组主面板页面分类，新增分析面板风格，统一生产管理、抽取成长、资源管理、任务成就、图鉴档案和系统设置等入口。
    - 重构数据中心与主要页面布局，统一卡片、网格、字号、间距和按钮状态，改善物品交互、配方图鉴、建筑操作、市场板等页面的可读性。
    - 优化分馏塔与物流交互站相关操作，补齐建筑培养、单路锁定、流动输出尾料释放、上传路径和增产点数处理等逻辑；精馏塔高阶特质改为低频萃取记忆源点，有限上传目标数量会随物品价值调整。
