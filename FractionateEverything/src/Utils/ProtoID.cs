...
public static partial class Utils {
    ...
    internal const int IFE交互塔 = 8101;
    internal const int IFE矿物复制塔 = 8102;
    internal const int IFE行星矿物复制塔 = 8103;
    internal const int IFE点数聚集塔 = 8104;
    internal const int IFE量子复制塔 = 8105;
    internal const int IFE点金塔 = 8106;
    internal const int IFE分解塔 = 8107;
    internal const int IFE转化塔 = 8108;
    internal const int IFE分馏原胚普通 = 8111;
    internal const int IFE分馏原胚精良 = 8112;
    internal const int IFE分馏原胚稀有 = 8113;
    internal const int IFE分馏原胚史诗 = 8114;
    internal const int IFE分馏原胚传说 = 8115;
    internal const int IFE分馏原胚定向 = 8116;
    internal const int IFE复制精华 = 8121;
    internal const int IFE点金精华 = 8122;
    internal const int IFE分解精华 = 8123;
    internal const int IFE转化精华 = 8124;
    internal const int IFE电磁奖券 = 8131;
    internal const int IFE能量奖券 = 8132;
    internal const int IFE结构奖券 = 8133;
    internal const int IFE信息奖券 = 8134;
    internal const int IFE引力奖券 = 8135;
    internal const int IFE宇宙奖券 = 8136;
    ...
    internal const int IFE速度插件MK2 = 2374;
    internal const int IFE速度插件MK3 = 2375;
    internal const int IFE产能插件MK1 = 2376;
    internal const int IFE产能插件MK2 = 2377;
    internal const int IFE产能插件MK3 = 2378;
    internal const int IFE节能插件MK1 = 2379;
    internal const int IFE节能插件MK2 = 2380;
    internal const int IFE节能插件MK3 = 2381;
    internal const int IFE净化插件MK1 = 2382;
    internal const int IFE净化插件MK2 = 2383;
    internal const int IFE净化插件MK3 = 2384;
    ...
    internal const int MFE交互塔 = 531;
    internal const int MFE矿物复制塔 = 532;
    internal const int MFE行星矿物复制塔 = 533;
    internal const int MFE点数聚集塔 = 534;
    internal const int MFE量子复制塔 = 535;
    internal const int MFE点金塔 = 536;
    internal const int MFE分解塔 = 537;
    internal const int MFE转化塔 = 538;
    internal const int MFE插件塔 = 541;
    ...
    internal const int RFE交互塔 = 901;
    internal const int RFE矿物复制塔 = 902;
    internal const int RFE行星矿物复制塔 = 903;
    internal const int RFE点数聚集塔 = 904;
    internal const int RFE量子复制塔 = 905;
    internal const int RFE点金塔 = 906;
    internal const int RFE分解塔 = 907;
    internal const int RFE转化塔 = 908;
    internal const int RFE分馏原胚普通 = 911;
    internal const int RFE分馏原胚精良 = 912;
    internal const int RFE分馏原胚稀有 = 913;
    internal const int RFE分馏原胚史诗 = 914;
    internal const int RFE分馏原胚传说 = 915;
    internal const int RFE分馏原胚定向 = 916;
    internal const int RFE复制精华 = 921;
    internal const int RFE点金精华 = 922;
    internal const int RFE分解精华 = 923;
    internal const int RFE转化精华 = 924;
    internal const int RFE电磁奖券 = 931;
    internal const int RFE能量奖券 = 932;
    internal const int RFE结构奖券 = 933;
    internal const int RFE信息奖券 = 934;
    internal const int RFE引力奖券 = 935;
    internal const int RFE宇宙奖券 = 936;
    internal const int RFE黑雾奖券 = 937;
    internal const int RFE分馏配方核心 = 938;
    internal const int RFE建筑增幅芯片 = 939;
    internal const int RFE残破核心 = 940;
    ...
    internal const int TFE分馏原胚 = 1750;
    internal const int TFE物品交互 = 1751;
    internal const int TFE矿物复制 = 1752;
    internal const int TFE行星矿物复制塔 = 1753;
    internal const int TFE增产点数聚集 = 1754;
    internal const int TFE量子复制 = 1755;
