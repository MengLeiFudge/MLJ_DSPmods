...
public static partial class Utils {
    ...
    internal const int IMS水滴额外伤害 = 8035;
    ...
    internal const int IFE插件塔 = 8201;
    internal const int IFE量子插件塔 = 8202;
    internal const int IFE速度插件MK1 = 8203;
    internal const int IFE速度插件MK2 = 8204;
    internal const int IFE速度插件MK3 = 8205;
    internal const int IFE产能插件MK1 = 8206;
    internal const int IFE产能插件MK2 = 8207;
    internal const int IFE产能插件MK3 = 8208;
    internal const int IFE节能插件MK1 = 8209;
    internal const int IFE节能插件MK2 = 8210;
    internal const int IFE节能插件MK3 = 8211;
    internal const int IFE净化插件MK1 = 8212;
    internal const int IFE净化插件MK2 = 8213;
    internal const int IFE净化插件MK3 = 8214;
    ...
    //↑创世会将400-600的配方减200↑
    //internal const int RGB天穹装配厂 = 376;
    //internal const int RGB物质裂解塔 = 377;
    //internal const int RGB巨型化学反应釜 = 378;
    //internal const int RGB精密结构组装厂 = 379;
    //internal const int RGB物质分解设施 = 380;
    //internal const int RGB巨型粒子对撞机 = 381;
