...
public static class ProtoID {
    ...
    internal const int RFE交互塔 = 301;
    internal const int RFE矿物复制塔 = 302;
    internal const int RFE行星矿物复制塔 = 303;
    internal const int RFE点数聚集塔 = 304;
    internal const int RFE量子复制塔 = 305;
    internal const int RFE点金塔 = 306;
    internal const int RFE分解塔 = 307;
    internal const int RFE转化塔 = 308;
    internal const int RFE分馏原胚普通 = 311;
    internal const int RFE分馏原胚精良 = 312;
    internal const int RFE分馏原胚稀有 = 313;
    internal const int RFE分馏原胚史诗 = 314;
    internal const int RFE分馏原胚传说 = 315;
    internal const int RFE分馏原胚定向 = 316;
    internal const int RFE复制精华 = 321;
    internal const int RFE点金精华 = 322;
    internal const int RFE分解精华 = 323;
    internal const int RFE转化精华 = 324;
    ...
    internal const int TFE交互塔 = 1751;
    internal const int TFE矿物复制塔 = 1752;
    internal const int TFE行星矿物复制塔 = 1753;
    internal const int TFE点数聚集塔 = 1754;
    internal const int TFE量子复制塔 = 1755;
    internal const int TFE点金塔 = 1756;
    internal const int TFE分解塔 = 1757;
    internal const int TFE转化塔 = 1758;
