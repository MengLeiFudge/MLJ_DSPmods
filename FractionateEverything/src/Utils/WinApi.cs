...
public static class WinApi {
    ...
    public static extern bool GetProcessAffinityMask(IntPtr hProcess, out ulong lpProcessAffinityMask,
    ...
    public static LogicalProcessorDetails GetLogicalProcessorDetails() {
        uint returnLength = 0;
        GetLogicalProcessorInformationEx(LOGICAL_PROCESSOR_RELATIONSHIP.RelationProcessorCore, IntPtr.Zero,
            ref returnLength);
        ...
        try {
            ...
            while (offset < returnLength) {
                var buffer =
                    (SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX)Marshal.PtrToStructure(item,
