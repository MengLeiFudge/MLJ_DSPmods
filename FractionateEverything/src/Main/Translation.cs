...
namespace FractionateEverything.Main {
    public static class Translation {
        public static void AddTranslations() {
            ...
            Register("T分馏塔产物集装物流", "Fractionator Product Integrated Count Logistics", "分馏塔产物集装物流");
            Register("分馏塔产物集装物流描述1",
                "Fractionator products will be exported as much as possible in product outgoing cargo.",
                "分馏塔的产物将会尽可能以集装形式输出。");
            Register("分馏塔产物集装物流结果1",
            ...
            Register("粒子对撞与通用分馏", "Particle Collisions and Universal Fractionation");
            Edit("微型粒子对撞机描述",
