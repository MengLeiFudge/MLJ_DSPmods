...
public static class FracTechManager {
    ...
    private static void AddTechFractionators() {
        ...
        // tech1621.AddItems = [IFE矿物复制塔];
        // tech1621.AddItemCounts = [3];
        // techs.Add(tech1621);
        //
        // var tech1622 = ProtoRegistry.RegisterTech(TFE升转化,
        //     "T升转化", "升转化描述", "升转化结果",
        //     "Assets/fracicons/tech升转化",
        //     [tech1621.ID],
        //     [I电磁矩阵], [20], 18000,
        //     [RFE转化塔, RFE转化塔],
        ...
        // techs.Add(tech1159);
        //
        // var tech1908 = ProtoRegistry.RegisterTech(TFE量子复制,
        //     "T量子复制", "量子复制描述", "量子复制结果",
        //     "Assets/fracicons/tech量子复制",
