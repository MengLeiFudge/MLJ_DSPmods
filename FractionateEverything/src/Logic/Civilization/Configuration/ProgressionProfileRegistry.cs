...
public static class ProgressionProfileRegistry {
    ...
    public static void Initialize() {
        Current = new ProgressionProfile("vanilla-compatible", 1, new List<MatrixStageDefinition> {
            new("electromagnetic", "文明阶段-电磁", 0, I电磁矩阵, IFE电磁解析数据),
            new("energy", "文明阶段-能量", 1, I能量矩阵, IFE能量解析数据),
            new("structure", "文明阶段-结构", 2, I结构矩阵, IFE结构解析数据),
            new("information", "文明阶段-信息", 3, I信息矩阵, IFE信息解析数据),
            new("gravity", "文明阶段-引力", 4, I引力矩阵, IFE引力解析数据),
            new("universe", "文明阶段-宇宙", 5, I宇宙矩阵, IFE宇宙解析数据),
        });
    }
}
