...
public class MyFlatButton : MonoBehaviour {
    ...
    public static MyFlatButton CreateFlatButton(float x, float y, RectTransform parent, string label = "",
        int fontSize = 15, Action<int> onClick = null) {
        return CreateFlatButton(x, y, parent, fontSize, onClick).WithLabelText(label);
    }

    public static MyFlatButton CreateFlatButton(float x, float y, RectTransform parent, int fontSize = 15,
