...
//         _initialized = true;
//         // TranslationUtils.Register("Cores: {0}\nThreads: {1}", "Cores: {0}\nThreads: {1}", "核心数: {0}\n线程数: {1}");
//         // TranslationUtils.Register("\nP-Cores: {0}\nE-Cores: {1}", "\nP-Cores: {0}\nE-Cores: {1}", "\n性能核心: {0}\n能效核心: {1}");
//         // TranslationUtils.Register("\nPriority: {0}", "\nProcess priority: {0}", "\n进程优先级: {0}");
//         // TranslationUtils.Register("\nEnabled CPUs: ", "\nEnabled CPUs: ", "\n使用的CPU: ");
//         // TranslationUtils.Register("Unknown", "Unknown", "未知");
...
//             _oldWndProc = WinApi.SetWindowLongPtr(gameWnd, WinApi.GWLP_WNDPROC,
//                 Marshal.GetFunctionPointerForDelegate(wndProc));
//         }
//
//         // ProcessPriority.SettingChanged += (_, _) =>
...
//         //             break;
//         //         case 1:
//         //             WinApi.SetProcessAffinityMask(process,
//         //                 systemMask & ((1UL << (ProcessorDetails.ThreadCount / 2)) - 1UL));
//         //             break;
//         //         case 2:
//         //             WinApi.SetProcessAffinityMask(process,
//         //                 systemMask & (ProcessorDetails.ThreadCount > 16 ? 0xFFUL : 1UL));
//         //             break;
//         //         case 3:
...
//     //     if (hybrid) {
//     //         msg += string.Format("\nP-Cores: {0}\nE-Cores: {1}".Translate(), details.PerformanceCoreCount,
//     //             details.EfficiencyCoreCount);
//     //     }
//     //
