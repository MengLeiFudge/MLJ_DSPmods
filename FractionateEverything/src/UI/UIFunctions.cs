...
public static class UIFunctions {
    ...
    public static void Init() {
        _toggleKey = KeyBindings.RegisterKeyBinding(new BuiltinKey {
            ...
            name = "OpenFEShopWindow",
            canOverride = true
        });
        TranslationUtils.Register("KEYOpenFEShopWindow", "[FE] Open Shop Window",
            "[FE] 打开商店窗口");

        // TranslationUtils.Register("Enable auto-cruise", "Enable auto-cruise", "启用自动巡航");
        // TranslationUtils.Register("Disable auto-cruise", "Disable auto-cruise", "禁用自动巡航");
        // TranslationUtils.Register("High yield", "High yield", "高产");
        // TranslationUtils.Register("Perfect", "Perfect", "完美");
        // TranslationUtils.Register("Union results", "Union results", "结果取并集");
        // TranslationUtils.Register("All 6 Basic Ores", "All 6 Basic Ores", "六种基础矿物齐全");
        // TranslationUtils.Register("Show original name", "Show original name", "显示原始名称");
        // TranslationUtils.Register("Show distance", "Show distance", "显示距离");
        // TranslationUtils.Register("Show planet count", "Show planet count", "显示行星数");
        // TranslationUtils.Register("Show all information", "Show all information", "显示全部信息");
    ...
    public static void InitToggleAutoCruiseCheckButton() {
        ...
        ToggleAutoCruise = MyCheckButton
            .CreateCheckButton(0, 0, lowGroup.GetComponent<RectTransform>(), FractionateEverything.AutoCruiseEnabled)
            .WithSize(120f, 40f);
    ...
    public static void UpdateToggleAutoCruiseCheckButtonVisiblility() {
        ...
        ToggleAutoCruise.gameObject.SetActive(true);
    }
    ...
    //     null,
    //     null,
    //     Util.LoadEmbeddedSprite("assets/planet_icon/07.png"),
    //     null,
    //     Util.LoadEmbeddedSprite("assets/planet_icon/09.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/10.png"),
    //     null,
    //     null,
    //     Util.LoadEmbeddedSprite("assets/planet_icon/13.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/14.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/15.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/16.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/17.png"),
    //     null,
    //     Util.LoadEmbeddedSprite("assets/planet_icon/19.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/20.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/21.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/22.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/23.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/24.png"),
    //     Util.LoadEmbeddedSprite("assets/planet_icon/25.png")
    // ];

    private static readonly (int, int)[] FilterVeinIds = [
        (9, 0), (10, 0), (11, 0), (12, 0), (13, 0), (14, 0), (7, 0), (0, 1116), (0, 1000), (8, 1011), (0, 1120),
        (0, 1121)
    ];
    ...
    public static void InitStarmapButtons() {
        ...
        var cornerComboBox = MyCornerComboBox.CreateComboBox(135, 0, rtrans, true).WithItems(
            "Show original name".Translate(), "Show distance".Translate(), "Show planet count".Translate(),
            "Show all information".Translate());
        cornerComboBox.SetIndex(CornerComboBoxIndex);
        cornerComboBox.OnSelChanged += (index) => { CornerComboBoxIndex = index; };
        StarmapFilterToggler = MyCheckButton.CreateCheckButton(0, 0, rtrans, false, ">>").WithSize(24, 24);
        MyCheckButton[] buttons = [
            MyCheckButton.CreateCheckButton(24, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Kimberlite
            MyCheckButton.CreateCheckButton(48, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Fractal Silicon
            MyCheckButton.CreateCheckButton(72, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Organic Crystal
            MyCheckButton.CreateCheckButton(96, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Grating Crystal
            MyCheckButton.CreateCheckButton(120, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Stalagmite Crystal
            MyCheckButton.CreateCheckButton(144, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Unipolar Magnet
            MyCheckButton.CreateCheckButton(168, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Crude Oil
            MyCheckButton.CreateCheckButton(192, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Fire Ice
            MyCheckButton.CreateCheckButton(216, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Sulfuric Acid
            MyCheckButton.CreateCheckButton(240, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Water
            MyCheckButton.CreateCheckButton(264, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Hydrogen
            MyCheckButton.CreateCheckButton(288, 0, rtrans, false).WithIcon().WithSize(24, 24)
                .WithIconWidth(24),// Deuterium
        ...
        var unionCheckBox = MyCheckBox.CreateCheckBox(312, 0, rtrans, false, "Union results".Translate(), 15)
            .WithSmallerBox(24f);
        unionCheckBox.gameObject.SetActive(false);
        unionCheckBox.OnChecked += () => { UpdateStarmapStarFilters(); };
            ...
            if (buttons != null) {
                ...
                for (int i = 0; i < FilterPlanetThemes.Length; i++) {
                    ...
                    switch (i) {
                        case 5:
                            buttons[12 + i]
                                .SetLabelText($"{themeProto.DisplayName.Translate()} ({"High yield".Translate()})");
                            break;
                        case 6:
                            buttons[12 + i]
                                .SetLabelText($"{themeProto.DisplayName.Translate()} ({"Perfect".Translate()})");
                            break;
                        default:
        ...
        void UpdateStarmapStarFilters() {
            ...
            for (int i = _starmapStarFilterValues.Length - 1; i >= 0; i--) {
                ShowStarName[i] = union
                    ? (_starmapStarFilterValues[i] & filterValue) != 0
                    : (_starmapStarFilterValues[i] & filterValue) == filterValue;
            }
    ...
    public static void OnPlanetScanEnded() {
        if (!_starmapFilterInitialized
            || StarmapFilterToggler == null
            || StarmapFilterToggler.gameObject.activeSelf) return;
    ...
    public static int CornerComboBoxIndex {
        ...
        set {
            ...
            // Patches.PlayerPatch.ShortcutKeysForStarsName.ForceShowAllStarsNameExternal =
            //     _cornerComboBoxIndex != 0 && !_starFilterEnabled;
    ...
    private static void UpdateStarmapStarNames() {
        foreach (var starUI in UIRoot.instance.uiGame.starmap.starUIs) {
            ...
            switch (_cornerComboBoxIndex) {
                case 1:
                    starUI.nameText.text =
                        String.Format("{0}-{1:0.00}", _starOrderNames[star.index], GetStarDist(star));
                    break;
                case 2: {
                ...
                case 3: {
                    var (nongas, total) = GetStarPlanetCount(star);
                    starUI.nameText.text = String.Format("{0}-{1:0.00}-{2}-{3}", _starOrderNames[star.index],
                        GetStarDist(star), nongas, total);
                    break;
                }
                default:
